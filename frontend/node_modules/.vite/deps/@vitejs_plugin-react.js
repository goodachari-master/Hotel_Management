...
async function loadBabel() {
  if (!babel)
    babel = await import("./lib-JWWO7QQ3.js");
  return babel;
}
...
function viteReact(opts = {}) {
  ...
  const viteReactRefresh = {
    ...
    load: {
      ...
      handler(id) {
        if (id === runtimePublicPath)
          return (0, import_node_fs2.readFileSync)(refreshRuntimePath, "utf-8").replace(/__README_URL__/g, "https://github.com/vitejs/vite-plugin-react/tree/main/packages/plugin-react");
      }
    },
